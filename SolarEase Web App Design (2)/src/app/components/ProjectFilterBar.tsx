...
export function ProjectFilterBar({
  ...
  return (
    <div className="flex items-center justify-between gap-4 flex-wrap bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
      {/* Status Tabs */}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm text-secondary hover:bg-slate-50 transition-colors shadow-sm"
          >
