...
export function ComparisonView({ data }: ComparisonViewProps) {
  ...
  const betterPayback = (night.financials.paybackPeriodYears || 0) <= (classic.financials.paybackPeriodYears || 0)
    ? "Night Panel"
    : "Classique";
  const betterRoi = (night.financials.roiPercentage || 0) >= (classic.financials.roiPercentage || 0)
    ? "Night Panel"
    : "Classique";
      ...
      <div className="bg-gradient-to-r from-green-500 via-emerald-500 to-indigo-500 rounded-2xl p-6 text-white">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-xl bg-white/15 border border-white/20 px-4 py-3">
            <p className="text-xs text-white/80">Meilleur ROI</p>
            <p className="text-sm font-semibold">{betterRoi}</p>
          </div>
          <div className="rounded-xl bg-white/15 border border-white/20 px-4 py-3">
            <p className="text-xs text-white/80">Meilleur payback</p>
            <p className="text-sm font-semibold">{betterPayback}</p>
          </div>
          <div className="rounded-xl bg-white/15 border border-white/20 px-4 py-3">
            <p className="text-xs text-white/80">Gain autoconsommation</p>
            <p className="text-sm font-semibold">+{Math.round(data.selfConsumptionGainPercent)}%</p>
          </div>
        </div>
      </div>
