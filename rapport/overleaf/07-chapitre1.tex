...
Prototypage de panneaux intelligents à \textbf{production nocturne}, innovations
domotiques et tests de nouvelles technologies énergétiques. C'est dans ce
département qu'est conçu le projet \textbf{Night Panel}~: une technologie visant
à produire de l'électricité la nuit en exploitant le rayonnement thermique
nocturne, complétant les panneaux photovoltaïques classiques. La plateforme
\textbf{SolarEase} intègre ce concept via un module de simulation et de
comparaison (\textit{Classique versus Night Panel}) au service des installateurs.
...
\subsection{Présentation générale du projet Night Panel}

Face à l'augmentation de la demande énergétique et aux limites des systèmes
photovoltaïques traditionnels, le projet \textbf{Night Panel} propose une
solution innovante permettant de produire de l'électricité durant la nuit afin
de compléter la production des panneaux solaires classiques. En effet, alors
que les panneaux photovoltaïques ne génèrent de l'énergie qu'en présence du
rayonnement solaire, Night Panel vise à exploiter les différences de température
et le rayonnement thermique nocturne pour assurer une production énergétique
continue.

Le concept repose sur l'utilisation de technologies capables de convertir
l'énergie thermique émise par la Terre vers le ciel nocturne en énergie
électrique. Associé à un système photovoltaïque conventionnel, Night Panel
permet d'améliorer le rendement global de l'installation et de tendre vers
une \textbf{disponibilité énergétique de 24~heures sur 24}.

Ce projet s'inscrit dans une démarche de transition énergétique durable en
cherchant à optimiser l'exploitation des ressources naturelles disponibles
aussi bien le jour que la nuit. L'objectif est de réduire la dépendance aux
systèmes de stockage coûteux, d'améliorer l'autonomie énergétique et de
contribuer au développement de solutions innovantes dans le domaine des
énergies renouvelables.

Dans le cadre du présent PFE, SolarEase ne reproduit pas le prototype matériel
Night Panel~; elle en \textbf{intègre la vision métier} en offrant aux
installateurs un outil de dimensionnement et de comparaison permettant
d'évaluer l'apport d'une solution hybride (production diurne PV + complément
nocturne) et d'en mesurer l'impact sur l'autoconsommation et la rentabilité
du projet client.
...
\begin{enumerate}
  ...
  \item Automatiser le calcul de dimensionnement photovoltaïque à partir des données
    d'irradiation PVGIS~;
  \item Proposer un mode \textit{Night Panel} simulant et comparant une
    installation complétée par une production nocturne (concept R\&D)~;
...
\begin{itemize}
  ...
  \item \textbf{L'innovation Night Panel}~: intégration du concept R\&D de
    production nocturne (rayonnement thermique) et comparaison avec le
    dimensionnement photovoltaïque classique~;
