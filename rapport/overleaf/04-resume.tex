...
scénarios \textit{Classique versus Night~Panel} (concept de production
nocturne complémentaire au PV),
...
API for real irradiance data, Classic vs.~Night~Panel scenario comparison (nocturnal production concept
complementing conventional PV), 25-year financial analysis, professional \textbf{PDF} report
