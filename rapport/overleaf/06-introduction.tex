...
\begin{enumerate}
  ...
  \item \textbf{Mode Night~Panel}~: intégration du concept R\&D \organisme{}
    visant une production électrique nocturne par conversion de l'énergie
    thermique, avec module de simulation permettant de comparer une installation
    classique à un scénario Night Panel (couverture étendue, autoconsommation,
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{4.5cm} X}
    ...
    factures, workflow commercial complet et envoi automatique des factures
    PDF par e-mail via \textbf{n8n} \\
    \addlinespace
    ...
    multi-environnements (Vercel + VM Microsoft Azure) \\
    \addlinespace[8pt]
    Conclusion générale &
