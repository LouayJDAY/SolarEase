...
%  Contient : Sprint 3 (Dimensionnement, IA, PDF) via \input{10-release2}
...
\begin{tabular}{|C{1cm}|L{4.5cm}|L{4cm}|C{2cm}|C{1.8cm}|}
  ...
  \hline
  SOLAR-22 & Facturation automatique & Génération facture à l'acceptation, PDF OpenPDF & Haute & \ok~Fait \\
  \hline
